...
class CpuInstructions(AbstractCpuInstructions):
    ...
    def ADC(self) -> int:
        ...
        self.cpu.state.flag_C = (temp > 255)
        self.cpu.state.flag_Z = ((temp & 0x00FF) == 0)
        self.cpu.state.flag_N = (temp & 0x80)
        self.cpu.state.flag_V = ((~(self.cpu.state.register_A ^ self.cpu.state.fetched) & (self.cpu.state.register_A ^ temp)) & 0x0080)
    ...
    def AND(self) -> int:
        ...
        self.cpu.state.flag_Z = (self.cpu.state.register_A == 0x00)
        self.cpu.state.flag_N = (self.cpu.state.register_A & 0x80)
    ...
    def ASL(self) -> int:
        ...
        self.cpu.state.flag_C = (temp & 0xFF00) > 0
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0
        self.cpu.state.flag_N = (temp & 0x80)
    ...
    def BCC(self) -> int:
        if not self.cpu.state.flag_C:
            ...
            self.cpu.state.addr_abs = (self.cpu.state.register_PC + self.addr_rel) & 0xFFFF
    ...
    def BIT(self) -> int:
        ...
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0x00
        self.cpu.state.flag_N = self.cpu.state.fetched & (1 << 7)
        self.cpu.state.flag_V = self.cpu.state.fetched & (1 << 6)
    ...
    def CLC(self) -> int:
        self.cpu.state.flag_C = 0
        return 0

    def CLD(self) -> int:
        self.cpu.state.flag_D = 0
        return 0

    def CLI(self) -> int:
        self.cpu.state.flag_I = 0
        return 0

    def CLV(self) -> int:
        self.cpu.state.flag_V = 0
        return 0

    def CMP(self) -> int:
        self.cpu.fetch()
        temp = self.cpu.state.register_A - self.cpu.state.fetched
        self.cpu.state.flag_C = self.cpu.state.register_A >= self.cpu.state.fetched
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0x0000
        self.cpu.state.flag_N = temp & 0x0080
        return 1

    def CPX(self) -> int:
        self.cpu.fetch()
        temp = self.cpu.state.register_X - self.cpu.state.fetched
        self.cpu.state.flag_C = self.cpu.state.register_X >= self.cpu.state.fetched
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0x0000
        self.cpu.state.flag_N = temp & 0x0080
        return 0
    ...
    def CPY(self) -> int:
        ...
        self.cpu.state.flag_C = self.cpu.state.register_Y >= self.cpu.state.fetched
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0x0000
        self.cpu.state.flag_N = temp & 0x0080
        return 0
    ...
    def DEX(self) -> int:
        ...
        self.cpu.state.flag_Z = self.cpu.state.register_X == 0x00
        self.cpu.state.flag_N = self.cpu.state.register_X & 0x80
        return 0

    def DEY(self) -> int:
        self.cpu.state.register_Y -= 1
        self.cpu.state.flag_Z = self.cpu.state.register_Y == 0x00
        self.cpu.state.flag_N = self.cpu.state.register_Y & 0x80
        return 0
    ...
    def LDX(self) -> int:
        ...
        self.cpu.state.flag_Z = int(self.cpu.state.register_X == 0x00)
        self.cpu.state.flag_N = self.cpu.state.register_X & 0x80
    ...
    def LSR(self) -> int:
        ...
        self.cpu.state.flag_C = self.cpu.state.fetched & 0x0001
        temp = self.cpu.state.fetched >> 1
    ...
    def PHP(self) -> int:
        ...
        self.cpu.state.flag_B = 0 # check if the
        self.cpu.state.flag_U = 0
        self.cpu.state.register_SP -= 1
        return 0
    ...
    def PLP(self) -> int:
        ...
        self.cpu.state.flag_C = (self.cpu.state.register_SR & 0b00000001)
        self.cpu.state.flag_Z = (self.cpu.state.register_SR & 0b00000010)
        self.cpu.state.flag_I = (self.cpu.state.register_SR & 0b00000100)
        self.cpu.state.flag_D = (self.cpu.state.register_SR & 0b00001000)
        self.cpu.state.flag_V = (self.cpu.state.register_SR & 0b01000000)
        self.cpu.state.flag_N = (self.cpu.state.register_SR & 0b10000000)
        self.cpu.state.flag_U = 1 << 5
    ...
    def ROL(self) -> int:
        ...
        self.cpu.state.flag_C = temp & 0xFF00
        self.cpu.state.flag_Z = (temp & 0x00FF) == 0x0000
        self.cpu.state.flag_N = temp & 0x0080
    ...
    def RTI(self) -> int:
        self.cpu.state.register_SP += 1
        self.cpu.state.register_SR = self.cpu.bus.read(0x0100 + self.cpu.state.register_SP)
        self.cpu.state.register_SR &= self.cpu.state.flag_B
        self.cpu.state.register_SR &= self.cpu.state.flag_U
    ...
    def SEC(self) -> int:
        self.cpu.state.flag_C = 1
        return 0

    def SED(self) -> int:
        self.cpu.state.flag_D = 1
        return 0
    ...
    def SBC(self) -> int:
        ...
        self.cpu.state.flag_C = (temp > 0xFF)
        self.cpu.state.flag_Z = ((temp & 0x00FF) == 0x0000)
        self.cpu.state.flag_N = (temp & 0x80)
        self.cpu.state.flag_V = ((self.cpu.state.register_A ^ temp) & (value ^ temp) & 0x0080) #TODO: Check this
        self.cpu.state.register_A = temp & 0x00FF
